...
of shelling out to ``python -m data_pipeline_template ...`` and parsing
stdout. Runs over stdio:

    uv run python -m data_pipeline_template.mcp_server
...
from data_pipeline_template.cli import pipelines_cmds, sources_cmds
from data_pipeline_template.sources import registry

mcp: FastMCP = FastMCP("data_pipeline_template")
