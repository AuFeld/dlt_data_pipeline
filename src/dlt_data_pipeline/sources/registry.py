...
``dlt_data_pipeline.sources.metadata``, both declared in
...
ENTRY_POINT_GROUP = "dlt_data_pipeline.sources"
ENTRY_POINT_METADATA_GROUP = "dlt_data_pipeline.sources.metadata"
